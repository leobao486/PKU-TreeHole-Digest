...
8. 学习、研究、职业和兴趣主题均以个人画像为准，不要在画像之外擅自设置用户偏好。
9. 转让、拼场或名额帖只在仍然有效时提高分数；正文或评论出现“已出、已转、已齐、已满、满员、没有空位”等完成状态时 relevance 必须为 0。
...
13. overview 是当前批次的整体概览，按照个人画像中的优先级概括最值得关注的主题，避免逐条罗列。
14. 必须输出 JSON 对象，格式为：
                    ...
                    "messages": [
                        {
                            ...
                            "content": (
                                ...
                                "只写一个自然段、2至3句话；按照个人画像的优先级概括最重要的信息，"
